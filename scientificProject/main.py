...
passengers = pd.read_csv("c:/users/aniks/downloads/passengers.csv")
...
if enter == True:
    ...
    if model.predict(output1) == 0:
        st.write("Unfortunately, based on the data you input you **would not** survive the Titanic")
    if model.predict(output1) == 1:
        st.write("Congratulations, based on the data you input you **would** survive the Titanic")
